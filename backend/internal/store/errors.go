...
var (
	...
	ErrCollaborationRunNotFound   = errors.New("collaboration run not found")
	ErrCollaborationRunFinished   = errors.New("collaboration run is already finished")
	ErrCollaborationRunTransition = errors.New("invalid collaboration run transition")
